"""
Django settings for autoML_final project.
...
SECRET_KEY = 'django-insecure-@ua37iqz#1o-a!42ag@gha59r)g)%s9t$@tm*mxx0jw#q%yom&'
...
WSGI_APPLICATION = 'autoML_final.wsgi.application'
