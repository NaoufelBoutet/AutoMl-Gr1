...
urlpatterns = [
    ...
    path('username/',autoML_views.espace_personel,name='perso'),
    path('sucess/',auth_user_views.success, name='success'),    
    path('username/import_data_home/', import_donnee_views.home_data, name='home_data'),
    path('username/upload_csv/',import_donnee_views.upload_csv,name='upload_csv'),
    path('username/result_csv/',import_donnee_views.result_csv,name='result_csv'),
    path('username/browse_file/',import_donnee_views.browse_file, name='browse_file'),
    path('username/filename/<str:filename>',import_donnee_views.read_csv,name='read_csv'),
    path('username/filename/<str:filename>/html',import_donnee_views.df_to_html,name='df_to_html')
]
